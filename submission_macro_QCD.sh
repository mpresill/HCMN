...
TASK="WZ_QCD" #EDIT: name of the output directory and the files
INPUT_DATASET=(`cat list_2016_WZ.txt`) #EDIT: name of the list 
...
# Preparing job code
#name of your macro
cp Rootplizer_HeavyNeutrino_QCD_2016.cc $JOB_FOLDER/${TASK}${i}.cc     #EDIT change name of the rootplizer
