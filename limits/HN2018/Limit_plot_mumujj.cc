...
//   Declare constants
/////
const double Luminosity = 58873; //pb^-1
//Plots
...
const string name_plot = "mumujj_L13000_2016-24July20_fitCR.pdf"; //xsecBR or r
const int    val       = 5;
...
double Obs[val]     = {};
double Exp_m2s[val] = {9.17E-04,	3.44E-04,	1.59E-04,	6.84E-05,	9.49E-06 };
double Exp_m1s[val] = {1.23E-03,	4.67E-04,	2.20E-04,	9.64E-05,	1.56E-05 };
double Exp[val]     = {1.74E-03,	6.66E-04,	3.22E-04,	1.45E-04,	2.73E-05 };  	//r value from Combine
double Exp_p1s[val] = {2.48E-03,	9.61E-04,	4.78E-04,	2.24E-04,	4.84E-05 };
double Exp_p2s[val] = {3.39E-03,	1.34E-03,	6.84E-04,	3.33E-04,	8.06E-05 };
...
// pt1->AddText("#Lambda = 12 TeV, MC signal #Lambda = 5 TeV");
 pt1->AddText("#scale[0.90]{CMS preliminary, #sqrt{s} = 13 TeV, L = 58.9 fb^{-1}}");
