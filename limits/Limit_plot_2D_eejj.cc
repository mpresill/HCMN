...
const string name_plot = "2D_limit_eejj_YearsCombined_CRfit.pdf"; //xsecBR or r
...
double Obs[val]       = {}; 
double LambdaExp[val] = {6.38,  7,    9,    11,   13,   15,    17,   20,  21, 21, 20};    //Lambda [TeV]
double Exp[val]       = {6.38,  6,  5.3,  4.6,  4.1,   3.5,   2.8,  2.15, 1, 1,  0.5};  //Mass [TeV]
...
void Limit_plot_2D_eejj(){
 ...
 gPad->RedrawAxis();
  ////
	...
	latexLabel2.SetNDC();
	latexLabel2.DrawLatex(0.75, 0.95, "136 fb^{-1} (13 TeV)"); 
