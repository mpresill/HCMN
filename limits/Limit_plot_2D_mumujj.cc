...
const string name_plot = "2D_limit_mumujj_YearsCombined_CRfit.pdf"; //xsecBR or r
...
double Obs[val]       = {}; 
double LambdaExp[val] = {5.65,  6,    7,   9,   11,   13,   15,   17,  18, 17};    //Lambda [TeV]
double Exp[val]       = {5.65, 5.5, 5.1, 4.2,  3.5,  2.8,  2.2,  1.4, 1, 0.5};  //Mass [TeV]
