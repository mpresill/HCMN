...
gROOT->Reset();
 ...
 tdrStyle->SetCanvasDefX(0);   //POsition on scrmumun
...
///////////////// FINE CONFIG 
   ...
   TFile *f1 = new TFile("histograms/mumujj_L13000_M1000_sr/mumujj_L13000_M1000_sr_YearsCombination_PostFit_histograms.root");
   TString name = "mumujj_FullRun2_M1000postfit_DYcr"; //nome del file salvato

   TString dir2016 = "DYcr_Y2016_DYcr_postfit/";
   TString dir2017 = "DYcr_Y2017_DYcr_postfit/";
   TString dir2018 = "DYcr_Y2018_DYcr_postfit/";
   //TString dir     = "postfit/";
...
/////input files
  ...
  TH1F *h4_c2017= (TH1F*) f1->Get(dir2017+"mumujj_L13_M1000");
   ...
   TH1F *h4_c2018= (TH1F*) f1->Get(dir2018+"mumujj_L13_M1000");
...
for(int i=1;i<10;i++){
 ...
 cout << "N_ev TOTAL "<<   Ntot_combine <<"+-"<< sqrt( Ntot_combine_err  )   <<endl;
 cout <<"====================="<<endl;
...
//	latexLabel2.SetTextFont(32);
	latexLabel2.SetNDC();
	latexLabel2.DrawLatex(0.76, 0.93, "136 fb^{-1} (13 TeV)");
