...
///////////////// FINE CONFIG 
   ...
   TString dir = "Y2016combined_signal_region_prefit/";
   TString name = "mumujj_2016_M1000prefit"; //nome del file salvato
...
//	latexLabel2.SetTextFont(32);
	latexLabel2.SetNDC();
	latexLabel2.DrawLatex(0.76, 0.93, "35.92 fb^{-1} (13 TeV)");
