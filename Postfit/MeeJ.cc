...
///////////////// FINE CONFIG 
   ...
   TFile *f1 = new TFile("histograms/eejj_L13000_M1000_sr_Rebinned/eejj_L13000_M1000_sr_YearsCombination_Rebinned_PostFit_histograms.root");
   TString name = "eejj_FullRun2_M1000postfit_Rebinned_19Feb"; //nome del file salvato
