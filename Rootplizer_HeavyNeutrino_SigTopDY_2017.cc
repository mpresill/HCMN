...
double musf_trigger(double eta, double pt){
 ...
 if(fabs(eta)>0.0 && fabs(eta)<=0.9){
    ...
    if(pt > 200.0 && pt <= 1200.0) musf=0.901651918888; // error 0.00303590818204 
}
if(fabs(eta)>1.2 && fabs(eta)<=2.1){
    ...
    if(pt > 200.0 && pt <= 1200.0) musf=0.881914794445; // error 0.0044963808387 
}
if(fabs(eta)>2.1 && fabs(eta)<=2.4){
    ...
    if(pt > 200.0 && pt <= 1200.0) musf=0.782012581825; // error 0.0166533859589 
}
if(fabs(eta)>0.9 && fabs(eta)<=1.2){
    ...
    if(pt > 200.0 && pt <= 1200.0) musf=0.864663362503; // error 0.00624873485522 
}
return musf;
}
...
double musf_ID(double eta, double pt){
 ...
 if(fabs(eta)>1.20 && fabs(eta)<=2.10){
    ...
    if(pt > 60.00 && pt <= 120.00) musf=0.999389952862; // error 0.00136819343082 
...
if(fabs(eta)>2.10 && fabs(eta)<=2.40){
    ...
    if(pt > 60.00 && pt <= 120.00) musf=0.998280825416; // error 0.00540182723314 
...
if(fabs(eta)>0.90 && fabs(eta)<=1.20){
    ...
    if(pt > 60.00 && pt <= 120.00) musf=0.999236708166; // error 0.00232070890495 
...
if(fabs(eta)>0.00 && fabs(eta)<=0.90){
    ...
    if(pt > 60.00 && pt <= 120.00) musf=1.00029091021; // error 0.000769284842631 
...
double musf_iso(double eta, double pt){
 ...
 if(fabs(eta)>1.20 && fabs(eta)<=2.10){
    ...
    if(pt > 60.00 && pt <= 120.00) musf=1.00042884607; // error 0.000527621298126 
...
if(fabs(eta)>2.10 && fabs(eta)<=2.40){
    ...
    if(pt > 60.00 && pt <= 120.00) musf=0.999185175032; // error 0.000869085318614 
...
if(fabs(eta)>0.90 && fabs(eta)<=1.20){
    ...
    if(pt > 60.00 && pt <= 120.00) musf=1.00018891743; // error 0.000685649929385 
...
if(fabs(eta)>0.00 && fabs(eta)<=0.90){
    ...
    if(pt > 60.00 && pt <= 120.00) musf=1.0000774755; // error 0.000352734665191 
