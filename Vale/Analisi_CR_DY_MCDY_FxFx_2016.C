...
//void filename_()
void Analisi_CR_DY_MCDY_FxFx_2016(){
...
TFile *f2 = new TFile("/eos/user/m/mpresill/CMS/HN_Reload/combine_histograms/SYST_2016-OldBinning/CR_DY_DY_FxFx_2016.root", "RECREATE"); 
n_best_Vtx_w->Write();
