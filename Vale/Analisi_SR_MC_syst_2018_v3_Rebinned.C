...
//void filename_()
void Analisi_SR_MC_syst_2018_v3_Rebinned(){
...
for (Int_t i=0;i<a_->GetEntries();i++) {
 ...
 if (Muon_pt->size() > 1 && numOfHighptMu==2 && numOfVetoEle == 0 && numOfBoostedJets>=1){
  ...
  if (HLT_Mu == 1 && Muon_pt->at(0) > 150 && Muon_pt->at(1) > 100 && fabs(Muon_eta->at(0))<2.4 && fabs(Muon_eta->at(1))<2.4 && BoostedJet_pt->at(0) > 190 && (Muon1+Muon2).M()  > 300 ){
   ...
   eejj_L13_M1000_mumujj_2018_PtResoUp->Fill((Muon1_PtResoUp+Muon2_PtResoUp+BoostJet).M(), wg);
   eejj_L13_M1000_mumujj_2018_PtResoDown->Fill((Muon1_PtResoDown+Muon2_PtResoDown+BoostJet).M(), wg);
  ...
  //DY cr Mll in 150-300 GeV
    ...
    eejj_L13_M1000_DYcr_mumujj_2018_PtResoDown->Fill((Muon1_PtResoDown+Muon2_PtResoDown+BoostJet).M(), wg);
 ...
 if (Muon_pt->size() > 0 && patElectron_pt->size() > 0 && numOfHighptMu==1 && numOfHighptEle == 1 && numOfBoostedJets>=1){
  ...
  if (HLT_Mu == 1 && LeadLep.Pt() > 150 && SubLeadLep.Pt() > 100 && fabs(Muon_eta->at(0))<2.4 && fabs(patElectron_eta->at(0))<2.4
   ...
   if (veto_ele == false){
    ...
    eejj_L13_M1000_TTtWcr_ll_2018_PtResoUp->Fill((Muon_PtResoUp+SubLeadLep).M(), wg);
    eejj_L13_M1000_TTtWcr_ll_2018_PtResoDown->Fill((Muon_PtResoDown+SubLeadLep).M(), wg);
    ...
    eejj_L13_M1000_TTtWcr_llJ_2018_PtResoUp->Fill((Muon_PtResoUp+SubLeadLep).M(),wg);
    eejj_L13_M1000_TTtWcr_llJ_2018_PtResoDown->Fill((Muon_PtResoDown+SubLeadLep).M(),wg);
    ...
    if(JesSFup->at(1)==1)eejj_L13_M1000_TTtWcr_llJ_2018_JesSFUp->Fill((LeadLep+SubLeadLep+BoostJet).M(), wg);
    if(JesSFdown->at(2)==1)eejj_L13_M1000_TTtWcr_llJ_2018_JesSFDown->Fill((LeadLep+SubLeadLep+BoostJet).M(), wg);
    if(JerSFup->at(3)==1)eejj_L13_M1000_TTtWcr_llJ_2018_JerSFUp->Fill((LeadLep+SubLeadLep+BoostJet).M(), wg);
    if(JerSFdown->at(4)==1)eejj_L13_M1000_TTtWcr_llJ_2018_JerSFDown->Fill((LeadLep+SubLeadLep+BoostJet).M(), wg);
   ...
   if (veto_ele == false){
    ...
    eejj_L13_M1000_TTtWcr_ll_2018_PtResoUp->Fill((Muon_PtResoUp+LeadLep).M(), wg);
    eejj_L13_M1000_TTtWcr_ll_2018_PtResoDown->Fill((Muon_PtResoDown+LeadLep).M(), wg);
    M_leplepJ_TTtWcr->Fill((LeadLep+SubLeadLep+BoostJet).M(),wg);
    ...
    eejj_L13_M1000_TTtWcr_llJ_PUUp->Fill((LeadLep+SubLeadLep+BoostJet).M(),wg_PUu);
    eejj_L13_M1000_TTtWcr_llJ_PUDown->Fill((LeadLep+SubLeadLep+BoostJet).M(),wg_PUd);
    eejj_L13_M1000_TTtWcr_llJ_2018_PtResoUp->Fill((Muon_PtResoUp+LeadLep).M(),wg);
    eejj_L13_M1000_TTtWcr_llJ_2018_PtResoDown->Fill((Muon_PtResoDown+LeadLep).M(),wg);
...
TFile *f = new TFile("/eos/user/m/mpresill/CMS/HN_Reload/combine_histograms/SYST_2018/SR_syst_eejj_L13_M1000_2018.root", "RECREATE");
