...
TH1D *TTtW_mumujj_2017_AlphaRatio = new TH1D ("TTtW_mumujj_2017_AlphaRatio", "TTtW_mumujj_2017_AlphaRatio", 9, asymbins);
TH1D *TTtW_mumujj_2017_AlphaRatioDown = new TH1D ("TTtW_mumujj_2017_AlphaRatioDown", "TTtW_mumujj_2017_AlphaRatioDown", 9, asymbins);
TH1D *TTtW_mumujj_2017_AlphaRatioUp = new TH1D ("TTtW_mumujj_2017_AlphaRatioUp", "TTtW_mumujj_2017_AlphaRatioUp", 9, asymbins);
TH1D *TTtW_mumujj_2017_SFUp = new TH1D ("TTtW_mumujj_2017_SFUp", "TTtW_mumujj_2017_SFUp", 9, asymbins);
TH1D *TTtW_mumujj_2017_SFDown = new TH1D ("TTtW_mumujj_2017_SFDown", "TTtW_mumujj_2017_SFDown", 9, asymbins);
TH1D *TTtW_mumujj_2017_PUUp = new TH1D ("TTtW_mumujj_2017_PUUp", "TTtW_mumujj_2017_PUUp", 9, asymbins);
TH1D *TTtW_mumujj_2017_PUDown = new TH1D ("TTtW_mumujj_2017_PUDown", "TTtW_mumujj_2017_PUDown", 9, asymbins);
TH1D *TTtW_mumujj_2017_centralJesJer = new TH1D ("TTtW_mumujj_2017_centralJesJer", "TTtW_mumujj_2017_centralJesJer", 9, asymbins);
TH1D *TTtW_mumujj_2017_JesSFUp = new TH1D ("TTtW_mumujj_2017_JesSFUp", "TTtW_mumujj_2017_JesSFUp", 9, asymbins);
TH1D *TTtW_mumujj_2017_JesSFDown = new TH1D ("TTtW_mumujj_2017_JesSFDown", "TTtW_mumujj_2017_JesSFDown", 9, asymbins);
TH1D *TTtW_mumujj_2017_JerSFUp = new TH1D ("TTtW_mumujj_2017_JerSFUp", "TTtW_mumujj_2017_JerSFUp", 9, asymbins);
TH1D *TTtW_mumujj_2017_JerSFDown = new TH1D ("TTtW_mumujj_2017_JerSFDown", "TTtW_mumujj_2017_JerSFDown", 9, asymbins);
//TH1D *TTtW_mumujj_2017_PtCorr = new TH1D ("TTtW_mumujj_2017_PtCorr", "TTtW_mumujj_2017_PtCorr", 9, asymbins);
//TH1D *TTtW_mumujj_2017_PtCorrDown = new TH1D ("TTtW_mumujj_2017_PtCorrDown", "TTtW_mumujj_2017_PtCorrDown", 9, asymbins);
//TH1D *TTtW_mumujj_2017_PtCorrUp = new TH1D ("TTtW_mumujj_2017_PtCorrUp", "TTtW_mumujj_2017_PtCorrUp", 9, asymbins);
TH1D *TTtW_mumujj_2017_PtResoUp  = new TH1D ("TTtW_mumujj_2017_PtResoUp", "TTtW_mumujj_2017_PtResoUp", 9, asymbins);
TH1D *TTtW_mumujj_2017_PtResoDown  = new TH1D ("TTtW_mumujj_2017_PtResoDown", "TTtW_mumujj_2017_PtResoDown", 9, asymbins);

TH1D *TTtW_eejj = new TH1D ("TTtW_eejj", "TTtW_eejj", 9, asymbins);
TH1D *TTtW_eejj_2017_AlphaRatio = new TH1D ("TTtW_eejj_2017_AlphaRatio", "TTtW_eejj_2017_AlphaRatio", 9, asymbins);
TH1D *TTtW_eejj_2017_AlphaRatioDown = new TH1D ("TTtW_eejj_2017_AlphaRatioDown", "TTtW_eejj_2017_AlphaRatioDown", 9, asymbins);
TH1D *TTtW_eejj_2017_AlphaRatioUp = new TH1D ("TTtW_eejj_2017_AlphaRatioUp", "TTtW_eejj_2017_AlphaRatioUp", 9, asymbins);
TH1D *TTtW_eejj_2017_SFUp = new TH1D ("TTtW_eejj_2017_SFUp", "TTtW_eejj_2017_SFUp", 9, asymbins);
TH1D *TTtW_eejj_2017_SFDown = new TH1D ("TTtW_eejj_2017_SFDown", "TTtW_eejj_2017_SFDown", 9, asymbins);
TH1D *TTtW_eejj_2017_PUUp = new TH1D ("TTtW_eejj_2017_PUUp", "TTtW_eejj_2017_PUUp", 9, asymbins);
TH1D *TTtW_eejj_2017_PUDown = new TH1D ("TTtW_eejj_2017_PUDown", "TTtW_eejj_2017_PUDown", 9, asymbins);
TH1D *TTtW_eejj_2017_centralJesJer = new TH1D ("TTtW_eejj_2017_centralJesJer", "TTtW_eejj_2017_centralJesJer", 9, asymbins);
TH1D *TTtW_eejj_2017_JesSFUp = new TH1D ("TTtW_eejj_2017_JesSFUp", "TTtW_eejj_2017_JesSFUp", 9, asymbins);
TH1D *TTtW_eejj_2017_JesSFDown = new TH1D ("TTtW_eejj_2017_JesSFDown", "TTtW_eejj_2017_JesSFDown", 9, asymbins);
TH1D *TTtW_eejj_2017_JerSFUp = new TH1D ("TTtW_eejj_2017_JerSFUp", "TTtW_eejj_2017_JerSFUp", 9, asymbins);
TH1D *TTtW_eejj_2017_JerSFDown = new TH1D ("TTtW_eejj_2017_JerSFDown", "TTtW_eejj_2017_JerSFDown", 9, asymbins);
TH1D *TTtW_eejj_2017_energyScaleUp = new TH1D ("TTtW_eejj_2017_energyScaleUp", "TTtW_eejj_2017_energyScaleUp", 9, asymbins);
TH1D *TTtW_eejj_2017_energyScaleDown = new TH1D ("TTtW_eejj_2017_energyScaleDown", "TTtW_eejj_2017_energyScaleDown", 9, asymbins);
TH1D *TTtW_eejj_2017_energySigmaUp = new TH1D ("TTtW_eejj_2017_energySigmaUp", "TTtW_eejj_2017_energySigmaUp", 9, asymbins);
TH1D *TTtW_eejj_2017_energySigmaDown = new TH1D ("TTtW_eejj_2017_energySigmaDown", "TTtW_eejj_2017_energySigmaDown", 9, asymbins);
...
TH1D *TTtW_DYcr_mumujj_2017_AlphaRatio = new TH1D ("TTtW_DYcr_mumujj_2017_AlphaRatio", "TTtW_DYcr_mumujj_2017_AlphaRatio", 9, asymbins);
TH1D *TTtW_DYcr_mumujj_2017_AlphaRatioUp = new TH1D ("TTtW_DYcr_mumujj_2017_AlphaRatioUp", "TTtW_DYcr_mumujj_2017_AlphaRatioUp", 9, asymbins);
TH1D *TTtW_DYcr_mumujj_2017_AlphaRatioDown = new TH1D ("TTtW_DYcr_mumujj_2017_AlphaRatioDown", "TTtW_DYcr_mumujj_2017_AlphaRatioDown", 9, asymbins);
TH1D *TTtW_DYcr_mumujj_2017_SFUp = new TH1D ("TTtW_DYcr_mumujj_2017_SFUp", "TTtW_DYcr_mumujj_2017_SFUp", 9, asymbins);
TH1D *TTtW_DYcr_mumujj_2017_SFDown = new TH1D ("TTtW_DYcr_mumujj_2017_SFDown", "TTtW_DYcr_mumujj_2017_SFDown", 9, asymbins);
TH1D *TTtW_DYcr_mumujj_2017_PUUp = new TH1D ("TTtW_DYcr_mumujj_2017_PUUp", "TTtW_DYcr_mumujj_2017_PUUp", 9, asymbins);
TH1D *TTtW_DYcr_mumujj_2017_PUDown = new TH1D ("TTtW_DYcr_mumujj_2017_PUDown", "TTtW_DYcr_mumujj_2017_PUDown", 9, asymbins);
TH1D *TTtW_DYcr_mumujj_centralJesJer = new TH1D ("TTtW_DYcr_mumujj_centralJesJer", "TTtW_DYcr_mumujj_centralJesJer", 9, asymbins);
TH1D *TTtW_DYcr_mumujj_2017_JesSFUp = new TH1D ("TTtW_DYcr_mumujj_2017_JesSFUp", "TTtW_DYcr_mumujj_2017_JesSFUp", 9, asymbins);
TH1D *TTtW_DYcr_mumujj_2017_JesSFDown = new TH1D ("TTtW_DYcr_mumujj_2017_JesSFDown", "TTtW_DYcr_mumujj_2017_JesSFDown", 9, asymbins);
TH1D *TTtW_DYcr_mumujj_2017_JerSFUp = new TH1D ("TTtW_DYcr_mumujj_2017_JerSFUp", "TTtW_DYcr_mumujj_2017_JerSFUp", 9, asymbins);
TH1D *TTtW_DYcr_mumujj_2017_JerSFDown = new TH1D ("TTtW_DYcr_mumujj_2017_JerSFDown", "TTtW_DYcr_mumujj_2017_JerSFDown", 9, asymbins);
//TH1D *TTtW_DYcr_mumujj_2017_PtCorrUp = new TH1D ("TTtW_DYcr_mumujj_2017_PtCorrUp", "TTtW_DYcr_mumujj_2017_PtCorrUp", 9, asymbins);
//TH1D *TTtW_DYcr_mumujj_2017_PtCorrDown = new TH1D ("TTtW_DYcr_mumujj_2017_PtCorrDown", "TTtW_DYcr_mumujj_2017_PtCorrDown", 9, asymbins);
TH1D *TTtW_DYcr_mumujj_2017_PtResoUp  = new TH1D ("TTtW_DYcr_mumujj_2017_PtResoUp", "TTtW_DYcr_mumujj_2017_PtResoUp", 9, asymbins);
TH1D *TTtW_DYcr_mumujj_2017_PtResoDown  = new TH1D ("TTtW_DYcr_mumujj_2017_PtResoDown", "TTtW_DYcr_mumujj_2017_PtResoDown", 9, asymbins);
TH1D *TTtW_DYcr_eejj = new TH1D ("TTtW_DYcr_eejj", "TTtW_DYcr_eejj", 9, asymbins);
TH1D *TTtW_DYcr_eejj_2017_AlphaRatio = new TH1D ("TTtW_DYcr_eejj_2017_AlphaRatio", "TTtW_DYcr_eejj_2017_AlphaRatio", 9, asymbins);
TH1D *TTtW_DYcr_eejj_2017_AlphaRatioUp = new TH1D ("TTtW_DYcr_eejj_2017_AlphaRatioUp", "TTtW_DYcr_eejj_2017_AlphaRatioUp", 9, asymbins);
TH1D *TTtW_DYcr_eejj_2017_AlphaRatioDown = new TH1D ("TTtW_DYcr_eejj_2017_AlphaRatioDown", "TTtW_DYcr_eejj_2017_AlphaRatioDown", 9, asymbins);
TH1D *TTtW_DYcr_eejj_2017_SFUp = new TH1D ("TTtW_DYcr_eejj_2017_SFUp", "TTtW_DYcr_eejj_2017_SFUp", 9, asymbins);
TH1D *TTtW_DYcr_eejj_2017_SFDown = new TH1D ("TTtW_DYcr_eejj_2017_SFDown", "TTtW_DYcr_eejj_2017_SFDown", 9, asymbins);
TH1D *TTtW_DYcr_eejj_2017_PUUp = new TH1D ("TTtW_DYcr_eejj_2017_PUUp", "TTtW_DYcr_eejj_2017_PUUp", 9, asymbins);
TH1D *TTtW_DYcr_eejj_2017_PUDown = new TH1D ("TTtW_DYcr_eejj_2017_PUDown", "TTtW_DYcr_eejj_2017_PUDown", 9, asymbins);
TH1D *TTtW_DYcr_eejj_centralJesJer = new TH1D ("TTtW_DYcr_eejj_centralJesJer", "TTtW_DYcr_eejj_centralJesJer", 9, asymbins);
TH1D *TTtW_DYcr_eejj_2017_JesSFUp = new TH1D ("TTtW_DYcr_eejj_2017_JesSFUp", "TTtW_DYcr_eejj_2017_JesSFUp", 9, asymbins);
TH1D *TTtW_DYcr_eejj_2017_JesSFDown = new TH1D ("TTtW_DYcr_eejj_2017_JesSFDown", "TTtW_DYcr_eejj_2017_JesSFDown", 9, asymbins);
TH1D *TTtW_DYcr_eejj_2017_JerSFUp = new TH1D ("TTtW_DYcr_eejj_2017_JerSFUp", "TTtW_DYcr_eejj_2017_JerSFUp", 9, asymbins);
TH1D *TTtW_DYcr_eejj_2017_JerSFDown = new TH1D ("TTtW_DYcr_eejj_2017_JerSFDown", "TTtW_DYcr_eejj_2017_JerSFDown", 9, asymbins);
TH1D *TTtW_DYcr_eejj_2017_energyScaleUp = new TH1D ("TTtW_DYcr_eejj_2017_energyScaleUp", "TTtW_DYcr_eejj_2017_energyScaleUp", 9, asymbins);
TH1D *TTtW_DYcr_eejj_2017_energyScaleDown = new TH1D ("TTtW_DYcr_eejj_2017_energyScaleDown", "TTtW_DYcr_eejj_2017_energyScaleDown", 9, asymbins);
TH1D *TTtW_DYcr_eejj_2017_energySigmaUp = new TH1D ("TTtW_DYcr_eejj_2017_energySigmaUp", "TTtW_DYcr_eejj_2017_energySigmaUp", 9, asymbins);
TH1D *TTtW_DYcr_eejj_2017_energySigmaDown = new TH1D ("TTtW_DYcr_eejj_2017_energySigmaDown", "TTtW_DYcr_eejj_2017_energySigmaDown", 9, asymbins);
...
TH1D *TTtW_TTtWcr_ll_2017_energyScaleUp = new TH1D ("TTtW_TTtWcr_ll_2017_energyScaleUp", "TTtW_TTtWcr_ll_2017_energyScaleUp", 6, asymbins2);
TH1D *TTtW_TTtWcr_ll_2017_energyScaleDown = new TH1D ("TTtW_TTtWcr_ll_2017_energyScaleDown", "TTtW_TTtWcr_ll_2017_energyScaleDown", 6, asymbins2);
...
TH1D *TTtW_TTtWcr_llJ_2017_AlphaRatio = new TH1D ("TTtW_TTtWcr_llJ_2017_AlphaRatio", "TTtW_TTtWcr_llJ_2017_AlphaRatio", 9, asymbins);
TH1D *TTtW_TTtWcr_llJ_2017_AlphaRatioUp = new TH1D ("TTtW_TTtWcr_llJ_2017_AlphaRatioUp", "TTtW_TTtWcr_llJ_2017_AlphaRatioUp", 9, asymbins);
TH1D *TTtW_TTtWcr_llJ_2017_AlphaRatioDown = new TH1D ("TTtW_TTtWcr_llJ_2017_AlphaRatioDown", "TTtW_TTtWcr_llJ_2017_AlphaRatioDown", 9, asymbins);
TH1D *TTtW_TTtWcr_llJ_2017_SFUp = new TH1D ("TTtW_TTtWcr_llJ_2017_SFUp", "TTtW_TTtWcr_llJ_2017_SFUp", 9, asymbins);
TH1D *TTtW_TTtWcr_llJ_2017_SFDown = new TH1D ("TTtW_TTtWcr_llJ_2017_SFDown", "TTtW_TTtWcr_llJ_2017_SFDown", 9, asymbins);
TH1D *TTtW_TTtWcr_llJ_2017_PUUp = new TH1D ("TTtW_TTtWcr_llJ_2017_PUUp", "TTtW_TTtWcr_llJ_2017_PUUp", 9, asymbins);
TH1D *TTtW_TTtWcr_llJ_2017_PUDown = new TH1D ("TTtW_TTtWcr_llJ_2017_PUDown", "TTtW_TTtWcr_llJ_2017_PUDown", 9, asymbins);
TH1D *TTtW_TTtWcr_llJ_2017_PtResoUp = new TH1D ("TTtW_TTtWcr_llJ_2017_PtResoUp", "TTtW_TTtWcr_llJ_2017_PtResoUp", 9, asymbins);
TH1D *TTtW_TTtWcr_llJ_2017_PtResoDown = new TH1D ("TTtW_TTtWcr_llJ_2017_PtResoDown", "TTtW_TTtWcr_llJ_2017_PtResoDown", 9, asymbins);
TH1D *TTtW_TTtWcr_llJ_2017_energyScaleUp = new TH1D ("TTtW_TTtWcr_llJ_2017_energyScaleUp", "TTtW_TTtWcr_llJ_2017_energyScaleUp", 9, asymbins);
TH1D *TTtW_TTtWcr_llJ_2017_energyScaleDown = new TH1D ("TTtW_TTtWcr_llJ_2017_energyScaleDown", "TTtW_TTtWcr_llJ_2017_energyScaleDown", 9, asymbins);
TH1D *TTtW_TTtWcr_llJ_2017_energySigmaUp = new TH1D ("TTtW_TTtWcr_llJ_2017_energySigmaUp", "TTtW_TTtWcr_llJ_2017_energySigmaUp", 9, asymbins);
TH1D *TTtW_TTtWcr_llJ_2017_energySigmaDown = new TH1D ("TTtW_TTtWcr_llJ_2017_energySigmaDown", "TTtW_TTtWcr_llJ_2017_energySigmaDown", 9, asymbins);
TH1D *TTtW_TTtWcr_llJ_centralJesJer = new TH1D ("TTtW_TTtWcr_llJ_centralJesJer", "TTtW_TTtWcr_llJ_centralJesJer", 9, asymbins);
TH1D *TTtW_TTtWcr_llJ_2017_JesSFUp = new TH1D ("TTtW_TTtWcr_llJ_2017_JesSFUp", "TTtW_TTtWcr_llJ_2017_JesSFUp", 9, asymbins);
TH1D *TTtW_TTtWcr_llJ_2017_JesSFDown = new TH1D ("TTtW_TTtWcr_llJ_2017_JesSFDown", "TTtW_TTtWcr_llJ_2017_JesSFDown", 9, asymbins);
TH1D *TTtW_TTtWcr_llJ_2017_JerSFUp = new TH1D ("TTtW_TTtWcr_llJ_2017_JerSFUp", "TTtW_TTtWcr_llJ_2017_JerSFUp", 9, asymbins);
TH1D *TTtW_TTtWcr_llJ_2017_JerSFDown = new TH1D ("TTtW_TTtWcr_llJ_2017_JerSFDown", "TTtW_TTtWcr_llJ_2017_JerSFDown", 9, asymbins);
...
//  cout << "wg_SFd =" <<wg_SFd <<endl;
 ...
 //   cout << "======="<<endl;
  ...
  if (HLT_Ele == 1 && patElectron_pt->at(0) > 150 && patElectron_pt->at(1) > 100 && fabs(patElectron_eta->at(1))<2.4 && fabs(patElectron_eta->at(0))<2.4 && BoostedJet_pt->at(0) > 190 && (Electron1+Electron2).M() > 300){
   ...
   TTtW_eejj_2017_energyScaleUp->Fill((Ele1_ScaleUp+Ele2_ScaleUp+BoostJet).M(), wg);
   TTtW_eejj_2017_energyScaleDown->Fill((Ele1_ScaleDown+Ele2_ScaleDown+BoostJet).M(), wg);
  ...
  if (HLT_Ele == 1 && patElectron_pt->at(0) > 150 && patElectron_pt->at(1) > 100 && fabs(patElectron_eta->at(1))<2.4 && fabs(patElectron_eta->at(0))<2.4 && BoostedJet_pt->at(0) > 190 && (Electron1+Electron2).M() >150 && (Electron1+Electron2).M() < 300){
   ...
   TTtW_DYcr_eejj_2017_energyScaleUp->Fill((Ele1_ScaleUp+Ele2_ScaleUp+BoostJet).M(), wg);
   TTtW_DYcr_eejj_2017_energyScaleDown->Fill((Ele1_ScaleDown+Ele2_ScaleDown+BoostJet).M(), wg);
...
double deltaEta = 0, deltaPhi = 0, deltaR = 0;
 ...
 if (Muon_pt->size() > 0 && patElectron_pt->size() > 0 && numOfHighptMu==1 && numOfHighptEle == 1 && numOfBoostedJets>=1){
  ...
  if (HLT_Mu == 1 && LeadLep.Pt() > 150 && SubLeadLep.Pt() > 100 && fabs(Muon_eta->at(0))<2.4 && fabs(patElectron_eta->at(0))<2.4
   ...
   TTtW_TTtWcr_ll_2017_energyScaleUp->Fill((Ele_ScaleUp+LeadLep).M(),wg);
    TTtW_TTtWcr_ll_2017_energyScaleDown->Fill((Ele_ScaleDown+LeadLep).M(),wg);
    ...
    TTtW_TTtWcr_llJ_2017_energyScaleUp->Fill((Ele_ScaleUp+LeadLep+BoostJet).M(),wg);
    TTtW_TTtWcr_llJ_2017_energyScaleDown->Fill((Ele_ScaleDown+LeadLep+BoostJet).M(),wg);
   ...
   if (veto_ele == false){
    ...
    TTtW_TTtWcr_ll_2017_PUDown->Fill((LeadLep+SubLeadLep).M(),wg_PUd);
     ...
     TTtW_TTtWcr_ll_2017_energyScaleUp->Fill((Ele_ScaleUp+SubLeadLep).M(),wg);
    TTtW_TTtWcr_ll_2017_energyScaleDown->Fill((Ele_ScaleDown+SubLeadLep).M(),wg);
    ...
    TTtW_TTtWcr_llJ_2017_energyScaleUp->Fill((Ele_ScaleUp+SubLeadLep+BoostJet).M(),wg);
    TTtW_TTtWcr_llJ_2017_energyScaleDown->Fill((Ele_ScaleDown+SubLeadLep+BoostJet).M(),wg);
...
TFile *f = new TFile("/eos/user/m/mpresill/CMS/HN_Reload/combine_histograms/SYST_2017_fixMuon/SR_syst_TTtW_2017.root", "RECREATE");
...
TTtW_eejj_2017_energyScaleUp->Write();
TTtW_eejj_2017_energyScaleDown->Write();
...
TTtW_DYcr_eejj_2017_energyScaleUp->Write();
TTtW_DYcr_eejj_2017_energyScaleDown->Write();
...
TTtW_TTtWcr_ll_2017_energyScaleUp->Write();
TTtW_TTtWcr_ll_2017_energyScaleDown->Write();
...
TTtW_TTtWcr_llJ_2017_energyScaleUp->Write();
TTtW_TTtWcr_llJ_2017_energyScaleDown->Write();
