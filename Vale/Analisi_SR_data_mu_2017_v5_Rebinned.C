...
//void filename_()
void Analisi_SR_data_mu_2017_v5_Rebinned(){
...
TFile *f = new TFile("/eos/user/m/mpresill/CMS/HN_Reload/combine_histograms/2017_ALL_HOPE/SR_data_mu_2017.root", "RECREATE");
