...
TH1F * gHisto ;
   ...
   TString name = "mumujj_2018_M1000postfit_DYcr_Rebinned"; //nome del file salvato
...
/////input files
   //2018
   TH1F *h1_c= (TH1F*) f1->Get(dir2018+"TTtW");
   TH1F *h2_c= (TH1F*) f1->Get(dir2018+"DY");
   TH1F *h2b_c= (TH1F*) f1->Get(dir2018+"Other");
   TH1F *h4_c= (TH1F*) f1->Get(dir2018+"mumujj_L13_M1000");
   TH1F *h5_c= (TH1F*) f1->Get(dir2018+"data_obs");
