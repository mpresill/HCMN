    ...
    if( rMuon_pt_tunePbt->at(mu_en)>20 && fabs(rMuon_eta->at(mu_en))<2.4){
     ...
     if(rMuon_isHighPt->at(mu_en)==1 && rMuon_TrackerIso->at(mu_en)<0.1){
      ...
      if(rMuon_pt_tunePbt->at(mu_en) < 200 ){
       ...
       num = 49 * gRandom->Rndm();
       float pt_corr = GE->GEScaleCorrPt(180000+(int)num, (float) rMuon_pt_tunePbt->at(mu_en), (float) rMuon_eta->at(mu_en),(float) rMuon_phi->at(mu_en), (int) rMuon_charge->at(mu_en), false);
...
// if(FileName.find("DY") != std::string::npos) wgt=6077./100194597; //NNLO
 ...
 //DY mass bins
 if(FileName.find("DY_M10To50") != std::string::npos) wgt=15810.0/(39392062+46976952);
 if(FileName.find("DY_M100To200") != std::string::npos) wgt=247.8/14255862;
 if(FileName.find("DY_M200To400") != std::string::npos) wgt=8.502/2587941;
 if(FileName.find("DY_M400To500") != std::string::npos) wgt=0.4514/487372;
 if(FileName.find("DY_M500To700") != std::string::npos) wgt=0.2558/481980;
 if(FileName.find("DY_M700To800") != std::string::npos) wgt=0.04023/446493;
 if(FileName.find("DY_M800To1000") != std::string::npos) wgt=0.03406/504407;
 if(FileName.find("DY_M1000To1500") != std::string::npos) wgt=0.01828/492743;
 if(FileName.find("DY_M1500To2000") != std::string::npos) wgt=0.002367/541461;
 if(FileName.find("DY_M2000To3000") != std::string::npos) wgt=0.0005409/489512;
