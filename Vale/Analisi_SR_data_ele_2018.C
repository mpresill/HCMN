...
TFile *f = new TFile("/eos/user/m/mpresill/CMS/HN_Reload/combine_histograms/SYST_2018-OldBinning/SR_data_ele_2018.root", "RECREATE");
NumFatJet->Write();
data_obs->Write();
f->Write();
f->Close();
