...
//void filename_()
void Analisi_SR_data_ele_2018_v5_Rebinned(){
...
TFile *f = new TFile("/eos/user/m/mpresill/CMS/HN_Reload/combine_histograms/2018_ALL_HOPE/SR_data_ele_2018.root", "RECREATE");
NumFatJet->Write();
data_obs->Write();
f->Write();
f->Close();
