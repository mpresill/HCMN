...
//void filename_()
void Analisi_CR_DY_data_2018_v5_Rebinned(){

TChain *a_ = new TChain("BOOM");

a_->Add("/eos/user/v/vmariani/NTuples/HN_2018/Syst_ALL_HOPE/data_ele_2018.root");
//inputFile
...
TFile *f = new TFile("/eos/user/m/mpresill/CMS/HN_Reload/combine_histograms/2018_ALL_HOPE/CR_DY_data_ele_2018.root", "RECREATE");
