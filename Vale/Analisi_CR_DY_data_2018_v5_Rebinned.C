...
//void filename_()
void Analisi_CR_DY_data_2018_Rebinned(){
...
TFile *f = new TFile("/eos/user/m/mpresill/CMS/HN_Reload/combine_histograms/2018_ALL_HOPE/CR_DY_data_mu_2018.root", "RECREATE");
