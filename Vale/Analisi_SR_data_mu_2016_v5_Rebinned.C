...
//void filename_()
void Analisi_SR_data_mu_2016_v5_Rebinned(){
...
TFile *f = new TFile("/eos/user/m/mpresill/CMS/HN_Reload/combine_histograms/2016_ALL_HOPE/SR_data_mu_2016.root", "RECREATE");
