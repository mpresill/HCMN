...
TH1D *TTtW_ll_2017_AlphaRatio = new TH1D ("TTtW_ll_2017_AlphaRatio", "TTtW_ll_2017_AlphaRatio", 8, asymbins);
TH1D *TTtW_ll_2017_AlphaRatioUp = new TH1D ("TTtW_ll_2017_AlphaRatioUp", "TTtW_ll_2017_AlphaRatioUp", 8, asymbins);
TH1D *TTtW_ll_2017_AlphaRatioDown = new TH1D ("TTtW_ll_2017_AlphaRatioDown", "TTtW_ll_2017_AlphaRatioDown", 8, asymbins);
TH1D *TTtW_ll_2017_SFUp = new TH1D ("TTtW_ll_2017_SFUp", "TTtW_ll_2017_SFUp", 8, asymbins);
TH1D *TTtW_ll_2017_SFDown = new TH1D ("TTtW_ll_2017_SFDown", "TTtW_ll_2017_SFDown", 8, asymbins);
TH1D *TTtW_ll_2017_PUUp = new TH1D ("TTtW_ll_2017_PUUp", "TTtW_ll_2017_PUUp", 8, asymbins);
TH1D *TTtW_ll_2017_PUDown = new TH1D ("TTtW_ll_2017_PUDown", "TTtW_ll_2017_PUDown", 8, asymbins);
TH1D *TTtW_ll_2017_PtCorrUp = new TH1D ("TTtW_ll_2017_PtCorrUp", "TTtW_ll_2017_PtCorrUp", 8, asymbins);
TH1D *TTtW_ll_2017_PtCorrDown = new TH1D ("TTtW_ll_2017_PtCorrDown", "TTtW_ll_2017_PtCorrDown", 8, asymbins);
TH1D *TTtW_ll_2017_energyScaleUp = new TH1D ("TTtW_ll_2017_energyScaleUp", "TTtW_ll_2017_energyScaleUp", 8, asymbins);
TH1D *TTtW_ll_2017_energyScaleDown = new TH1D ("TTtW_ll_2017_energyScaleDown", "TTtW_ll_2017_energyScaleDown", 8, asymbins);
TH1D *TTtW_ll_2017_energySigmaUp = new TH1D ("TTtW_ll_2017_energySigmaUp", "TTtW_ll_2017_energySigmaUp", 8, asymbins);
TH1D *TTtW_ll_2017_energySigmaDown = new TH1D ("TTtW_ll_2017_energySigmaDown", "TTtW_ll_2017_energySigmaDown", 8, asymbins);
TH1D *TTtW_ll_centralJesJer = new TH1D ("TTtW_ll_centralJesJer", "TTtW_ll_centralJesJer", 8, asymbins);
TH1D *TTtW_ll_2017_JesSFUp = new TH1D ("TTtW_ll_2017_JesSFUp", "TTtW_ll_2017_JesSFUp", 8, asymbins);
TH1D *TTtW_ll_2017_JesSFDown = new TH1D ("TTtW_ll_2017_JesSFDown", "TTtW_ll_2017_JesSFDown", 8, asymbins);
TH1D *TTtW_ll_2017_JerSFUp = new TH1D ("TTtW_ll_2017_JerSFUp", "TTtW_ll_2017_JerSFUp", 8, asymbins);
TH1D *TTtW_ll_2017_JerSFDown = new TH1D ("TTtW_ll_2017_JerSFDown", "TTtW_ll_2017_JerSFDown", 8, asymbins);
 ...
 if (Muon_pt->size() > 0 && patElectron_pt->size() > 0 && numOfHighptMu==1 && numOfHighptEle == 1 && numOfBoostedJets>=1){
  ...
  if (Muon_pt->at(0) >= patElectron_pt->at(0)){
   ...
   if (veto_ele == false){
    ...
    TTtW_ll_2017_AlphaRatio->Fill((LeadLep+SubLeadLep).M(),wg);
    TTtW_ll_2017_AlphaRatioUp->Fill((LeadLep+SubLeadLep).M(),wg);
    TTtW_ll_2017_AlphaRatioDown->Fill((LeadLep+SubLeadLep).M(),wg);
    TTtW_ll_2017_SFUp->Fill((LeadLep+SubLeadLep).M(),wg_SFup);
    TTtW_ll_2017_SFDown->Fill((LeadLep+SubLeadLep).M(),wg_SFdown);
    TTtW_ll_2017_PUUp->Fill((LeadLep+SubLeadLep).M(),wg_PUup);

    TTtW_ll_2017_PUDown->Fill((LeadLep+SubLeadLep).M(),wg_PUdown);
    TTtW_ll_2017_PtCorrUp->Fill((Muon_ptCorr+SubLeadLep).M(),wg);
    TTtW_ll_2017_PtCorrDown->Fill((Muon_ptCorr+SubLeadLep).M(),wg);
    TTtW_ll_2017_energyScaleUp->Fill((Ele_ScaleUp+LeadLep).M(),wg);
    TTtW_ll_2017_energyScaleDown->Fill((Ele_ScaleDown+LeadLep).M(),wg);
    TTtW_ll_2017_energySigmaUp->Fill((Ele_SigmaUp+LeadLep).M(),wg);
    TTtW_ll_2017_energySigmaDown->Fill((Ele_SigmaDown+LeadLep).M(),wg);
    ...
    if(JerSFup->at(3)==1)TTtW_ll_2017_JerSFUp->Fill((LeadLep+SubLeadLep).M(), wg);
    if(JerSFdown->at(4)==1)TTtW_ll_2017_JerSFDown->Fill((LeadLep+SubLeadLep).M(), wg);
   ...
   if (veto_ele == false){
    ...
    TTtW_ll_2017_PtCorrUp->Fill((Muon_ptCorr+LeadLep).M(),wg);
    TTtW_ll_2017_PtCorrDown->Fill((Muon_ptCorr+LeadLep).M(),wg);
    TTtW_ll_2017_energyScaleUp->Fill((Ele_ScaleUp+SubLeadLep).M(),wg);
    TTtW_ll_2017_energyScaleDown->Fill((Ele_ScaleDown+SubLeadLep).M(),wg);
    TTtW_ll_2017_energySigmaUp->Fill((Ele_SigmaUp+SubLeadLep).M(),wg);
    TTtW_ll_2017_energySigmaDown->Fill((Ele_SigmaDown+SubLeadLep).M(),wg);
...
TFile *f = new TFile("plot/CR_TTtW_TTtW_2017_syst.root", "RECREATE");
...
TTtW_ll_2017_AlphaRatioDown->Write();
TTtW_ll_2017_SFUp->Write();
TTtW_ll_2017_SFDown->Write();
TTtW_ll_2017_PUUp->Write();
TTtW_ll_2017_PUDown->Write();
TTtW_ll_2017_PtCorrUp->Write();
TTtW_ll_2017_PtCorrDown->Write();
TTtW_ll_2017_energyScaleUp->Write();
TTtW_ll_2017_energyScaleDown->Write();
TTtW_ll_2017_energySigmaUp->Write();
TTtW_ll_2017_energySigmaDown->Write();
TTtW_ll_centralJesJer->Write();
TTtW_ll_2017_JesSFUp->Write();
TTtW_ll_2017_JesSFDown->Write();
TTtW_ll_2017_JerSFUp->Write();
TTtW_ll_2017_JerSFDown->Write();
