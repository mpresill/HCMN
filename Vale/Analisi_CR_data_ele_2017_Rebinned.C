...
//void filename_()
void Analisi_CR_data_ele_2017_Rebinned(){
...
TFile *f = new TFile("/eos/user/m/mpresill/CMS/HN_Reload/combine_histograms/SYST_2017/CR_DY_data_ele_2017.root", "RECREATE");
