...
void DH_dy_Mllj_CR_2017_muon_Kfactor()
{
 setTDRStyle();
...
//========================================
 int iPeriod = 5; //periodo 4='16, periodo 5='17, periodo 6='18
 c1( iPeriod, 11 );
}
...
//===================================================
//file for 2017 
TFile *f00_ = new TFile("/eos/user/m/mpresill/CMS/HN_Reload/combine_histograms/SYST_2017-OldBinning/SR_syst_DY_Kewkqcd_2017.root");
TFile *f01_ = new TFile("/eos/user/m/mpresill/CMS/HN_Reload/combine_histograms/SYST_2017-OldBinning/SR_syst_TTtW_2017.root");
TFile *f02_ = new TFile("/eos/user/m/mpresill/CMS/HN_Reload/combine_histograms/SYST_2017-OldBinning/SR_syst_Other_2017.root");
...
TString nameDY="DY_DYcr_mumujj_2017_AlphaRatio";
...
//============================================
//d->SetMaximum(4500); 
//d->GetYaxis()->SetRangeUser(0,8000); //for 2017 Meej
...
//==========================================
//2017 
  canv->Print("/eos/user/m/mpresill/www/HN/DY/CR150-300/"+canvName+"_2017_Kewkqcd_CR150-300GeV_AlphaRBinned.png");
  canv->Print("/eos/user/m/mpresill/www/HN/DY/CR150-300/"+canvName+"_2017_Kewkqcd_CR150-300GeV_AlphaRBinned.pdf");
//2017 
