...
//========================================
 int iPeriod = 6; //periodo 4=2016, periodo 5=2018, periodo 6=2018
 c1( iPeriod, 11 );
}
...
TFile *f00_ = new TFile("/eos/user/m/mpresill/CMS/HN_Reload/combine_histograms/SYST_2018-OldBinning/CR_DY_DY_2018.root");
...
//2018 
  canv->Print("/eos/user/m/mpresill/www/HN/DY/"+canvName+"_2018.png");
  canv->Print("/eos/user/m/mpresill/www/HN/DY/"+canvName+"_2018.pdf");
//2018 
