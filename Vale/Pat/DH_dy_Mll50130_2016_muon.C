...
//REPLACE HERE 1  - to choose electrons or muons
//===================================================
//file for 2016 
...
//==================================================
//need to rescale the binning
int bin=5; //here change binning for the Z mass plot  50-130

//====================================================
//Plot definition

TString name="M_mumu_Z_50130";      // this is plot in fig.17  
//TString name="M_mumu_Z_50130";      // this is plot in fig.17  
...
//============================================
d->SetMaximum(4500);    //do we need this? 
...
//here error calculation for the ratio
int v = 0;
v = nbin/bin;
...
//d->GetXaxis()->SetTitle("M (llj) [GeV]");
    //d->GetXaxis()->SetTitle("M (#mu #mu) [GeV]");
//do you need this axis name????
d->GetXaxis()->SetLabelSize(25);
