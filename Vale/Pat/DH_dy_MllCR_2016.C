...
//===================================================
//file for 2016 
TFile *f00_ = new TFile("/afs/cern.ch/work/m/mpresill/public/DY_test/CR_DY_DY_Kewkqcd_2016.root");
...
TString name="M_ee_100300";      //this is for the sideband fit for systematics
...
int binmax = d->GetBinContent(d->GetMaximumBin());
//============================================
//REPLACE HERE 4 -- to change the maximum (if needed) 
//============================================
d->GetYaxis()->SetRangeUser(0,100); //for 2016 ee100300 sideband
d->SetMinimum(0.5);
canv->cd();
...
d->GetXaxis()->SetRangeUser(150, 300); 
...
dataSUmc->GetXaxis()->SetLimits(150,300);//this for sideband fit
...
TLine* line = new TLine(150,1,300,1);     //per Pt(ll) larghezza linea rossa (specificare x1, x2)
