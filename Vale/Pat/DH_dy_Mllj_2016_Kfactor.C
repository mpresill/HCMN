...
//===================================================
//file for 2016 
TFile *f00_ = new TFile("/eos/user/m/mpresill/CMS/HN_Reload/combine_histograms/SYST_2016-OldBinning/CR_DY_DY_Kewkqcd_2016.root");
TFile *f01_ = new TFile("/eos/user/m/mpresill/CMS/HN_Reload/combine_histograms/SYST_2016-OldBinning/CR_DY_TTtW_2016.root");
TFile *f02_ = new TFile("/eos/user/m/mpresill/CMS/HN_Reload/combine_histograms/SYST_2016-OldBinning/CR_DY_Other_2016.root");
...
//============================================
//d->SetMaximum(4500); 
//d->GetYaxis()->SetRangeUser(0,5000); //for 2016 Meej
d->GetYaxis()->SetRangeUser(0,1.8*(d->GetBinContent(d->GetMaximumBin()))); //for 2016 Meej
d->SetMinimum(0.5);
canv->cd();
...
//==========================================
//2016 
  canv->Print("/eos/user/m/mpresill/www/HN/DY/"+canvName+"_2016_Kewkqcd.png");
  canv->Print("/eos/user/m/mpresill/www/HN/DY/"+canvName+"_2016_Kewkqcd.pdf");
//2017 
