...
//============================================
d->GetYaxis()->SetRangeUser(0,180); //for 2016 ee100300 sideband
d->SetMinimum(0.5);
canv->cd();
...
//2018 
canv->Print("/eos/user/m/mpresill/www/HN/DY/"+canvName+"_2018_Kewkqcd.png");
canv->Print("/eos/user/m/mpresill/www/HN/DY/"+canvName+"_2018_Kewkqcd.pdf");
 return canv;
