...
TH1F * gHisto ;
   ...
   TString name = "eejj_2018_M1000prefit_DYcr_Rebinned"; //nome del file salvato

   TString dir2018 = "DYcr_Y2018_DYcr_prefit/";
   //TString dir     = "prefit/";
...
/////input files
   ...
   TH1F *h4_c= (TH1F*) f1->Get(dir2018+"eejj_L13_M1000");
