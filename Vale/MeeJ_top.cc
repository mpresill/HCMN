...
TH1F * gHisto ;
   ...
   TString name = "eejj_FullRun2_M1000prefit_TOPcr_Rebinned"; //nome del file salvato
...
canv->Print(name+".png");
canv->Print(name+".pdf");
canv->Print("/eos/user/m/mpresill/www/HN/prefit/"+name+".png");
canv->Print("/eos/user/m/mpresill/www/HN/prefit/"+name+".pdf");
