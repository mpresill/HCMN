...
//void filename_()
void Analisi_SR_data_mu_2018_v5_Rebinned(){
...
TFile *f = new TFile("/eos/user/m/mpresill/CMS/HN_Reload/combine_histograms/2018_ALL_HOPE/SR_data_mu_2018.root", "RECREATE");
NumFatJet_mu->Write();
data_obs->Write();
f->Write();
f->Close();
