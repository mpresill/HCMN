...
TH1D *WJets_incl_mumujj = new TH1D ("WJets_incl_mumujj", "WJets_incl_mumujj", 8, asymbins);
TH1D *WJets_incl_mumujj_2016_AlphaRatio = new TH1D ("WJets_incl_mumujj_2016_AlphaRatio", "WJets_incl_mumujj_2016_AlphaRatio", 8, asymbins);
TH1D *WJets_incl_mumujj_2016_AlphaRatioUp = new TH1D ("WJets_incl_mumujj_2016_AlphaRatioUp", "WJets_incl_mumujj_2016_AlphaRatioUp", 8, asymbins);
TH1D *WJets_incl_mumujj_2016_AlphaRatioDown = new TH1D ("WJets_incl_mumujj_2016_AlphaRatioDown", "WJets_incl_mumujj_2016_AlphaRatioDown", 8, asymbins);
TH1D *WJets_incl_mumujj_2016_SFUp = new TH1D ("WJets_incl_mumujj_2016_SFUp", "WJets_incl_mumujj_2016_SFUp", 8, asymbins);
TH1D *WJets_incl_mumujj_2016_SFDown = new TH1D ("WJets_incl_mumujj_2016_SFDown", "WJets_incl_mumujj_2016_SFDown", 8, asymbins);
TH1D *WJets_incl_mumujj_2016_PUUp = new TH1D ("WJets_incl_mumujj_2016_PUUp", "WJets_incl_mumujj_2016_PUUp", 8, asymbins);
TH1D *WJets_incl_mumujj_2016_PUDown = new TH1D ("WJets_incl_mumujj_2016_PUDown", "WJets_incl_mumujj_2016_PUDown", 8, asymbins);
TH1D *WJets_incl_mumujj_centralJesJer = new TH1D ("WJets_incl_mumujj_centralJesJer", "WJets_incl_mumujj_centralJesJer", 8, asymbins);
TH1D *WJets_incl_mumujj_2016_JesSFUp = new TH1D ("WJets_incl_mumujj_2016_JesSFUp", "WJets_incl_mumujj_2016_JesSFUp", 8, asymbins);
TH1D *WJets_incl_mumujj_2016_JesSFDown = new TH1D ("WJets_incl_mumujj_2016_JesSFDown", "WJets_incl_mumujj_2016_JesSFDown", 8, asymbins);
TH1D *WJets_incl_mumujj_2016_JerSFUp = new TH1D ("WJets_incl_mumujj_2016_JerSFUp", "WJets_incl_mumujj_2016_JerSFUp", 8, asymbins);
TH1D *WJets_incl_mumujj_2016_JerSFDown = new TH1D ("WJets_incl_mumujj_2016_JerSFDown", "WJets_incl_mumujj_2016_JerSFDown", 8, asymbins);
TH1D *WJets_incl_mumujj_2016_PtCorrUp = new TH1D ("WJets_incl_mumujj_2016_PtCorrUp", "WJets_incl_mumujj_2016_PtCorrUp", 8, asymbins);
TH1D *WJets_incl_mumujj_2016_PtCorrDown = new TH1D ("WJets_incl_mumujj_2016_PtCorrDown", "WJets_incl_mumujj_2016_PtCorrDown", 8, asymbins);
TH1D *WJets_incl_eejj = new TH1D ("WJets_incl_eejj", "WJets_incl_eejj", 8, asymbins);
TH1D *WJets_incl_eejj_2016_AlphaRatio = new TH1D ("WJets_incl_eejj_2016_AlphaRatio", "WJets_incl_eejj_2016_AlphaRatio", 8, asymbins);
TH1D *WJets_incl_eejj_2016_AlphaRatioUp = new TH1D ("WJets_incl_eejj_2016_AlphaRatioUp", "WJets_incl_eejj_2016_AlphaRatioUp", 8, asymbins);
TH1D *WJets_incl_eejj_2016_AlphaRatioDown = new TH1D ("WJets_incl_eejj_2016_AlphaRatioDown", "WJets_incl_eejj_2016_AlphaRatioDown", 8, asymbins);
TH1D *WJets_incl_eejj_2016_SFUp = new TH1D ("WJets_incl_eejj_2016_SFUp", "WJets_incl_eejj_2016_SFUp", 8, asymbins);
TH1D *WJets_incl_eejj_2016_SFDown = new TH1D ("WJets_incl_eejj_2016_SFDown", "WJets_incl_eejj_2016_SFDown", 8, asymbins);
TH1D *WJets_incl_eejj_2016_PUUp = new TH1D ("WJets_incl_eejj_2016_PUUp", "WJets_incl_eejj_2016_PUUp", 8, asymbins);
TH1D *WJets_incl_eejj_2016_PUDown = new TH1D ("WJets_incl_eejj_2016_PUDown", "WJets_incl_eejj_2016_PUDown", 8, asymbins);
TH1D *WJets_incl_eejj_centralJesJer = new TH1D ("WJets_incl_eejj_centralJesJer", "WJets_incl_eejj_centralJesJer", 8, asymbins);
TH1D *WJets_incl_eejj_2016_JesSFUp = new TH1D ("WJets_incl_eejj_2016_JesSFUp", "WJets_incl_eejj_2016_JesSFUp", 8, asymbins);
TH1D *WJets_incl_eejj_2016_JesSFDown = new TH1D ("WJets_incl_eejj_2016_JesSFDown", "WJets_incl_eejj_2016_JesSFDown", 8, asymbins);
TH1D *WJets_incl_eejj_2016_JerSFUp = new TH1D ("WJets_incl_eejj_2016_JerSFUp", "WJets_incl_eejj_2016_JerSFUp", 8, asymbins);
TH1D *WJets_incl_eejj_2016_JerSFDown = new TH1D ("WJets_incl_eejj_2016_JerSFDown", "WJets_incl_eejj_2016_JerSFDown", 8, asymbins);
TH1D *WJets_incl_eejj_2016_energyScaleUp = new TH1D ("WJets_incl_eejj_2016_energyScaleUp", "WJets_incl_eejj_2016_energyScaleUp", 8, asymbins);
TH1D *WJets_incl_eejj_2016_energyScaleDown = new TH1D ("WJets_incl_eejj_2016_energyScaleDown", "WJets_incl_eejj_2016_energyScaleDown", 8, asymbins);
TH1D *WJets_incl_eejj_2016_energySigmaUp = new TH1D ("WJets_incl_eejj_2016_energySigmaUp", "WJets_incl_eejj_2016_energySigmaUp", 8, asymbins);
TH1D *WJets_incl_eejj_2016_energySigmaDown = new TH1D ("WJets_incl_eejj_2016_energySigmaDown", "WJets_incl_eejj_2016_energySigmaDown", 8, asymbins);
...
for (Int_t i=0;i<a_->GetEntries();i++) {
 ...
 if (Muon_pt->size() > 1 && numOfHighptMu==2 && numOfVetoEle == 0 && numOfBoostedJets>=1){
  ...
  if (HLT_Mu == 1 && Muon_pt->at(0) > 150 && Muon_pt->at(1) > 100 && fabs(Muon_eta->at(0))<2.4 && fabs(Muon_eta->at(1))<2.4 && BoostedJet_pt->at(0) > 190 && (Muon1+Muon2).M() > 300 ){
   ...
   WJets_incl_mumujj->Fill((Muon1+Muon2+BoostJet).M(), wg); 
   cout << "wg " << wg << " lumi " << lumi << " lumi_wgt " << lumi_wgt << " lepsf_evt " << lepsf_evt << " PUWeight " << PUWeight << endl;
   WJets_incl_mumujj_2016_AlphaRatio->Fill((Muon1+Muon2+BoostJet).M(), wg*1.04);
   WJets_incl_mumujj_2016_AlphaRatioUp->Fill((Muon1+Muon2+BoostJet).M(), wg*1.14);
   WJets_incl_mumujj_2016_AlphaRatioDown->Fill((Muon1+Muon2+BoostJet).M(), wg*0.94);
   WJets_incl_mumujj_2016_SFUp->Fill((Muon1+Muon2+BoostJet).M(), wg_2016_SFUp);
   WJets_incl_mumujj_2016_SFDown->Fill((Muon1+Muon2+BoostJet).M(), wg_2016_SFDown);
   WJets_incl_mumujj_2016_PUUp->Fill((Muon1+Muon2+BoostJet).M(), wg_2016_PUUp);
   WJets_incl_mumujj_2016_PUDown->Fill((Muon1+Muon2+BoostJet).M(), wg_2016_PUDown);
   WJets_incl_mumujj_2016_PtCorrUp->Fill((Muon1_ptCorr+Muon2_ptCorr+BoostJet).M(), wg);
   WJets_incl_mumujj_2016_PtCorrDown->Fill((Muon1_ptCorr+Muon2_ptCorr+BoostJet).M(), wg);
   if(centralJesJer->at(0)==1)WJets_incl_mumujj_centralJesJer->Fill((Muon1+Muon2+BoostJet).M(), wg);
   if(JesSFup->at(1)==1)WJets_incl_mumujj_2016_JesSFUp->Fill((Muon1+Muon2+BoostJet_JESup).M(), wg);
   if(JesSFdown->at(2)==1)WJets_incl_mumujj_2016_JesSFDown->Fill((Muon1+Muon2+BoostJet_JESdown).M(), wg);
   if(JerSFup->at(3)==1)WJets_incl_mumujj_2016_JerSFUp->Fill((Muon1+Muon2+BoostJet_JERup).M(), wg);
   if(JerSFdown->at(4)==1)WJets_incl_mumujj_2016_JerSFDown->Fill((Muon1+Muon2+BoostJet_JERdown).M(), wg);  
  }
 }
 ...
 if (patElectron_pt->size() > 1 && numOfHighptEle==2 && numOfLooseMu==0 && numOfBoostedJets>=1){
  ...
  if (HLT_Ele == 1 && patElectron_pt->at(0) > 150 && patElectron_pt->at(1) > 100 && fabs(patElectron_eta->at(1))<2.4 && fabs(patElectron_eta->at(0))<2.4 && BoostedJet_pt->at(0) > 190 && (Electron1+Electron2).M() > 300){
   ...
   WJets_incl_eejj->Fill((Electron1+Electron2+BoostJet).M(), wg);
   WJets_incl_eejj_2016_AlphaRatio->Fill((Electron1+Electron2+BoostJet).M(), wg*1.07);
   WJets_incl_eejj_2016_AlphaRatioUp->Fill((Electron1+Electron2+BoostJet).M(), wg*1.32);
   WJets_incl_eejj_2016_AlphaRatioDown->Fill((Electron1+Electron2+BoostJet).M(), wg*0.82);
   WJets_incl_eejj_2016_SFUp->Fill((Electron1+Electron2+BoostJet).M(), wg_2016_SFUp);
   WJets_incl_eejj_2016_SFDown->Fill((Electron1+Electron2+BoostJet).M(), wg_2016_SFDown);
   WJets_incl_eejj_2016_PUUp->Fill((Electron1+Electron2+BoostJet).M(), wg_2016_PUUp);
   WJets_incl_eejj_2016_PUDown->Fill((Electron1+Electron2+BoostJet).M(), wg_2016_PUDown);
   WJets_incl_eejj_2016_energyScaleUp->Fill((Ele1_ScaleUp+Ele2_ScaleUp+BoostJet).M(), wg);
   WJets_incl_eejj_2016_energyScaleDown->Fill((Ele1_ScaleDown+Ele2_ScaleDown+BoostJet).M(), wg);
   WJets_incl_eejj_2016_energySigmaUp->Fill((Ele1_SigmaUp+Ele2_SigmaUp+BoostJet).M(), wg);
   WJets_incl_eejj_2016_energySigmaDown->Fill((Ele1_SigmaDown+Ele2_SigmaDown+BoostJet).M(), wg);
   if(centralJesJer->at(0)==1)WJets_incl_eejj_centralJesJer->Fill((Electron1+Electron2+BoostJet).M(), wg);
   if(JesSFup->at(1)==1)WJets_incl_eejj_2016_JesSFUp->Fill((Electron1+Electron2+BoostJet_JESup).M(), wg);
   if(JesSFdown->at(2)==1)WJets_incl_eejj_2016_JesSFDown->Fill((Electron1+Electron2+BoostJet_JESdown).M(), wg);
   if(JerSFup->at(3)==1)WJets_incl_eejj_2016_JerSFUp->Fill((Electron1+Electron2+BoostJet_JERup).M(), wg);
   if(JerSFdown->at(4)==1)WJets_incl_eejj_2016_JerSFDown->Fill((Electron1+Electron2+BoostJet_JERdown).M(), wg); 
  }
 } 
...
WJets_incl_eejj->Write();
WJets_incl_eejj_2016_AlphaRatio->Write();
WJets_incl_eejj_2016_AlphaRatioUp->Write();
WJets_incl_eejj_2016_AlphaRatioDown->Write();
WJets_incl_eejj_2016_SFUp->Write();
WJets_incl_eejj_2016_SFDown->Write();
WJets_incl_eejj_2016_PUUp->Write();
WJets_incl_eejj_2016_PUDown->Write();
WJets_incl_eejj_centralJesJer->Write();
WJets_incl_eejj_2016_JesSFUp->Write();
WJets_incl_eejj_2016_JesSFDown->Write();
WJets_incl_eejj_2016_JerSFUp->Write();
WJets_incl_eejj_2016_JerSFDown->Write();
WJets_incl_eejj_2016_energyScaleUp->Write();
WJets_incl_eejj_2016_energyScaleDown->Write();
WJets_incl_eejj_2016_energySigmaUp->Write();
WJets_incl_eejj_2016_energySigmaDown->Write();
WJets_incl_mumujj->Write();
WJets_incl_mumujj_2016_AlphaRatio->Write();
WJets_incl_mumujj_2016_AlphaRatioUp->Write();
WJets_incl_mumujj_2016_AlphaRatioDown->Write();
WJets_incl_mumujj_2016_SFUp->Write();
WJets_incl_mumujj_2016_SFDown->Write();
WJets_incl_mumujj_2016_PUUp->Write();
WJets_incl_mumujj_2016_PUDown->Write();
WJets_incl_mumujj_centralJesJer->Write();
WJets_incl_mumujj_2016_JesSFUp->Write();
WJets_incl_mumujj_2016_JesSFDown->Write();
WJets_incl_mumujj_2016_JerSFUp->Write();
WJets_incl_mumujj_2016_JerSFDown->Write();
WJets_incl_mumujj_2016_PtCorrDown->Write();
WJets_incl_mumujj_2016_PtCorrUp->Write();
f->Write();
f->Close();
