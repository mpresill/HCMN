...
//void filename_()
void Analisi_CR_TTtW_MC_fit(){

TChain *a_ = new TChain("BOOM");

a_->Add("/eos/user/v/vmariani/NTuples/HN_2018/Syst_ALL/TTtW_2018.root");
...
TH1D *TTtW_ll = new TH1D ("TTtW_ll", "TTtW_ll", 8, asymbins);
TH1D *TTtW_ll_2018_AlphaRatio = new TH1D ("TTtW_ll_2018_AlphaRatio", "TTtW_ll_2018_AlphaRatio", 8, asymbins);
TH1D *TTtW_ll_2018_AlphaRatioUp = new TH1D ("TTtW_ll_2018_AlphaRatioUp", "TTtW_ll_2018_AlphaRatioUp", 8, asymbins);
TH1D *TTtW_ll_2018_AlphaRatioDown = new TH1D ("TTtW_ll_2018_AlphaRatioDown", "TTtW_ll_2018_AlphaRatioDown", 8, asymbins);
TH1D *TTtW_ll_2018_SFUp = new TH1D ("TTtW_ll_2018_SFUp", "TTtW_ll_2018_SFUp", 8, asymbins);
TH1D *TTtW_ll_2018_SFDown = new TH1D ("TTtW_ll_2018_SFDown", "TTtW_ll_2018_SFDown", 8, asymbins);
TH1D *TTtW_ll_2018_PUUp = new TH1D ("TTtW_ll_2018_PUUp", "TTtW_ll_2018_PUUp", 8, asymbins);
TH1D *TTtW_ll_2018_PUDown = new TH1D ("TTtW_ll_2018_PUDown", "TTtW_ll_2018_PUDown", 8, asymbins);
TH1D *TTtW_ll_2018_PtCorrUp = new TH1D ("TTtW_ll_2018_PtCorrUp", "TTtW_ll_2018_PtCorrUp", 8, asymbins);
TH1D *TTtW_ll_2018_PtCorrDown = new TH1D ("TTtW_ll_2018_PtCorrDown", "TTtW_ll_2018_PtCorrDown", 8, asymbins);
TH1D *TTtW_ll_2018_energyScaleUp = new TH1D ("TTtW_ll_2018_energyScaleUp", "TTtW_ll_2018_energyScaleUp", 8, asymbins);
TH1D *TTtW_ll_2018_energyScaleDown = new TH1D ("TTtW_ll_2018_energyScaleDown", "TTtW_ll_2018_energyScaleDown", 8, asymbins);
TH1D *TTtW_ll_2018_energySigmaUp = new TH1D ("TTtW_ll_2018_energySigmaUp", "TTtW_ll_2018_energySigmaUp", 8, asymbins);
TH1D *TTtW_ll_2018_energySigmaDown = new TH1D ("TTtW_ll_2018_energySigmaDown", "TTtW_ll_2018_energySigmaDown", 8, asymbins);
TH1D *TTtW_ll_centralJesJer = new TH1D ("TTtW_ll_centralJesJer", "TTtW_ll_centralJesJer", 8, asymbins);
TH1D *TTtW_ll_2018_JesSFUp = new TH1D ("TTtW_ll_2018_JesSFUp", "TTtW_ll_2018_JesSFUp", 8, asymbins);
TH1D *TTtW_ll_2018_JesSFDown = new TH1D ("TTtW_ll_2018_JesSFDown", "TTtW_ll_2018_JesSFDown", 8, asymbins);
TH1D *TTtW_ll_2018_JerSFUp = new TH1D ("TTtW_ll_2018_JerSFUp", "TTtW_ll_2018_JerSFUp", 8, asymbins);
TH1D *TTtW_ll_2018_JerSFDown = new TH1D ("TTtW_ll_2018_JerSFDown", "TTtW_ll_2018_JerSFDown", 8, asymbins); 
 ...
 if (Muon_pt->size() > 0 && patElectron_pt->size() > 0 && numOfHighptMu==1 && numOfHighptEle == 1 && numOfBoostedJets>=1){
  ...
  if (HLT_Mu == 1 && LeadLep.Pt() > 150 && SubLeadLep.Pt() > 100 && fabs(Muon_eta->at(0))<2.4 && fabs(patElectron_eta->at(0))<2.4 
   ...
   if (veto_ele == false){
    ...
    TTtW_ll_2018_AlphaRatio->Fill((LeadLep+SubLeadLep).M(),wg);
    TTtW_ll_2018_AlphaRatioUp->Fill((LeadLep+SubLeadLep).M(),wg);
    TTtW_ll_2018_AlphaRatioDown->Fill((LeadLep+SubLeadLep).M(),wg);     
    TTtW_ll_2018_SFUp->Fill((LeadLep+SubLeadLep).M(),wg_SFup);
    TTtW_ll_2018_SFDown->Fill((LeadLep+SubLeadLep).M(),wg_SFdown);
    TTtW_ll_2018_PUUp->Fill((LeadLep+SubLeadLep).M(),wg_PUup);

    TTtW_ll_2018_PUDown->Fill((LeadLep+SubLeadLep).M(),wg_PUdown);
    TTtW_ll_2018_PtCorrUp->Fill((Muon_ptCorr+SubLeadLep).M(),wg);
    TTtW_ll_2018_PtCorrDown->Fill((Muon_ptCorr+SubLeadLep).M(),wg);
    TTtW_ll_2018_energyScaleUp->Fill((Ele_ScaleUp+LeadLep).M(),wg);
    TTtW_ll_2018_energyScaleDown->Fill((Ele_ScaleDown+LeadLep).M(),wg);
    TTtW_ll_2018_energySigmaUp->Fill((Ele_SigmaUp+LeadLep).M(),wg);
    TTtW_ll_2018_energySigmaDown->Fill((Ele_SigmaDown+LeadLep).M(),wg);

    if(centralJesJer->at(0)==1)TTtW_ll_centralJesJer->Fill((LeadLep+SubLeadLep).M(), wg);
    if(JesSFup->at(1)==1)TTtW_ll_2018_JesSFUp->Fill((LeadLep+SubLeadLep).M(), wg);
    if(JesSFdown->at(2)==1)TTtW_ll_2018_JesSFDown->Fill((LeadLep+SubLeadLep).M(), wg);
    if(JerSFup->at(3)==1)TTtW_ll_2018_JerSFUp->Fill((LeadLep+SubLeadLep).M(), wg);
    if(JerSFdown->at(4)==1)TTtW_ll_2018_JerSFDown->Fill((LeadLep+SubLeadLep).M(), wg);
   ...
   if (veto_ele == false){
    ...
    TTtW_ll_2018_PtCorrUp->Fill((Muon_ptCorr+LeadLep).M(),wg);
    TTtW_ll_2018_PtCorrDown->Fill((Muon_ptCorr+LeadLep).M(),wg);
    TTtW_ll_2018_energyScaleUp->Fill((Ele_ScaleUp+SubLeadLep).M(),wg);
    TTtW_ll_2018_energyScaleDown->Fill((Ele_ScaleDown+SubLeadLep).M(),wg);
    TTtW_ll_2018_energySigmaUp->Fill((Ele_SigmaUp+SubLeadLep).M(),wg);
    TTtW_ll_2018_energySigmaDown->Fill((Ele_SigmaDown+SubLeadLep).M(),wg);
...
TFile *f = new TFile("plot/CR_TTtW_TTtW_2018_syst.root", "RECREATE");
...
M_ll_puw->Write();
TTtW_ll->Write();
TTtW_ll_2018_AlphaRatio->Write();
TTtW_ll_2018_AlphaRatioUp->Write();
TTtW_ll_2018_AlphaRatioDown->Write();
TTtW_ll_2018_SFUp->Write();
TTtW_ll_2018_SFDown->Write();
TTtW_ll_2018_PUUp->Write();
TTtW_ll_2018_PUDown->Write();
TTtW_ll_2018_PtCorrUp->Write();
TTtW_ll_2018_PtCorrDown->Write();
TTtW_ll_2018_energyScaleUp->Write();
TTtW_ll_2018_energyScaleDown->Write();
TTtW_ll_2018_energySigmaUp->Write();
TTtW_ll_2018_energySigmaDown->Write();
TTtW_ll_centralJesJer->Write();
TTtW_ll_2018_JesSFUp->Write();
TTtW_ll_2018_JesSFDown->Write();
TTtW_ll_2018_JerSFUp->Write();
TTtW_ll_2018_JerSFDown->Write();
