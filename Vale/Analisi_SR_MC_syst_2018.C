...
TH1D *mumujj_L13_M8000_mumujj_2018_PtCorr = new TH1D ("mumujj_L13_M8000_mumujj_2018_PtCorr", "mumujj_L13_M8000_mumujj_2018_PtCorr", 9, asymbins);
...
for (Int_t i=0;i<a_->GetEntries();i++) {
 ...
 if (Muon_pt->size() > 1 && numOfHighptMu==2 && numOfVetoEle == 0 && numOfBoostedJets>=1){
  ...
  //DY cr Mll in 150-300 GeV
    ...
    mumujj_L13_M8000_DYcr_mumujj_2018_PtCorrUp->Fill((Muon1_ptCorr+Muon2_ptCorr+BoostJet).M(), wg);
    mumujj_L13_M8000_DYcr_mumujj_2018_PtCorrDown->Fill((Muon1_ptCorr+Muon2_ptCorr+BoostJet).M(), wg);
...
TFile *f = new TFile("/eos/user/m/mpresill/CMS/HN_Reload/combine_histograms/SYST_2018-OldBinning/SR_syst_mumujj_L13_M8000_2018.root", "RECREATE");
