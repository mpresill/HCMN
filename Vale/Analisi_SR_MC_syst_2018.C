...
a_->Add("/eos/user/v/vmariani/NTuples/HN_2018/Syst_ALL/WJets_nobin_2018.root");
...
TH1D *WJets_nobin_mumujj = new TH1D ("WJets_nobin_mumujj", "WJets_nobin_mumujj", 8, asymbins);
TH1D *WJets_nobin_mumujj_2018_AlphaRatio = new TH1D ("WJets_nobin_mumujj_2018_AlphaRatio", "WJets_nobin_2018_mumujj_AlphaRatio", 8, asymbins);
TH1D *WJets_nobin_mumujj_2018_AlphaRatioDown = new TH1D ("WJets_nobin_mumujj_2018_AlphaRatioDown", "WJets_nobin_mumujj_2018_AlphaRatioDown", 8, asymbins);
TH1D *WJets_nobin_mumujj_2018_AlphaRatioUp = new TH1D ("WJets_nobin_mumujj_2018_AlphaRatioUp", "WJets_nobin_mumujj_2018_AlphaRatioUp", 8, asymbins);
TH1D *WJets_nobin_mumujj_2018_SFUp = new TH1D ("WJets_nobin_mumujj_2018_SFUp", "WJets_nobin_mumujj_2018_SFUp", 8, asymbins);
TH1D *WJets_nobin_mumujj_2018_SFDown = new TH1D ("WJets_nobin_mumujj_2018_SFDown", "WJets_nobin_mumujj_2018_SFDown", 8, asymbins);
TH1D *WJets_nobin_mumujj_2018_PUUp = new TH1D ("WJets_nobin_mumujj_2018_PUUp", "WJets_nobin_mumujj_2018_PUUp", 8, asymbins);
TH1D *WJets_nobin_mumujj_2018_PUDown = new TH1D ("WJets_nobin_mumujj_2018_PUDown", "WJets_nobin_mumujj_2018_PUDown", 8, asymbins);
TH1D *WJets_nobin_mumujj_2018_centralJesJer = new TH1D ("WJets_nobin_mumujj_2018_centralJesJer", "WJets_nobin_mumujj_2018_centralJesJer", 8, asymbins);
TH1D *WJets_nobin_mumujj_2018_JesSFUp = new TH1D ("WJets_nobin_mumujj_2018_JesSFUp", "WJets_nobin_mumujj_2018_JesSFUp", 8, asymbins);
TH1D *WJets_nobin_mumujj_2018_JesSFDown = new TH1D ("WJets_nobin_mumujj_2018_JesSFDown", "WJets_nobin_mumujj_2018_JesSFDown", 8, asymbins);
TH1D *WJets_nobin_mumujj_2018_JerSFUp = new TH1D ("WJets_nobin_mumujj_2018_JerSFUp", "WJets_nobin_mumujj_2018_JerSFUp", 8, asymbins);
TH1D *WJets_nobin_mumujj_2018_JerSFDown = new TH1D ("WJets_nobin_mumujj_2018_JerSFDown", "WJets_nobin_mumujj_2018_JerSFDown", 8, asymbins);
TH1D *WJets_nobin_mumujj_2018_PtCorr = new TH1D ("WJets_nobin_mumujj_2018_PtCorr", "WJets_nobin_mumujj_2018_PtCorr", 8, asymbins);
TH1D *WJets_nobin_mumujj_2018_PtCorrDown = new TH1D ("WJets_nobin_mumujj_2018_PtCorrDown", "WJets_nobin_mumujj_2018_PtCorrDown", 8, asymbins);
TH1D *WJets_nobin_mumujj_2018_PtCorrUp = new TH1D ("WJets_nobin_mumujj_2018_PtCorrUp", "WJets_nobin_mumujj_2018_PtCorrUp", 8, asymbins);
TH1D *WJets_nobin_eejj = new TH1D ("WJets_nobin_eejj", "WJets_nobin_eejj", 8, asymbins);
TH1D *WJets_nobin_eejj_2018_AlphaRatio = new TH1D ("WJets_nobin_eejj_2018_AlphaRatio", "WJets_nobin_eejj_2018_AlphaRatio", 8, asymbins);
TH1D *WJets_nobin_eejj_2018_AlphaRatioDown = new TH1D ("WJets_nobin_eejj_2018_AlphaRatioDown", "WJets_nobin_eejj_2018_AlphaRatioDown", 8, asymbins);
TH1D *WJets_nobin_eejj_2018_AlphaRatioUp = new TH1D ("WJets_nobin_eejj_2018_AlphaRatioUp", "WJets_nobin_eejj_2018_AlphaRatioUp", 8, asymbins);
TH1D *WJets_nobin_eejj_2018_SFUp = new TH1D ("WJets_nobin_eejj_2018_SFUp", "WJets_nobin_eejj_2018_SFUp", 8, asymbins);
TH1D *WJets_nobin_eejj_2018_SFDown = new TH1D ("WJets_nobin_eejj_2018_SFDown", "WJets_nobin_eejj_2018_SFDown", 8, asymbins);
TH1D *WJets_nobin_eejj_2018_PUUp = new TH1D ("WJets_nobin_eejj_2018_PUUp", "WJets_nobin_eejj_2018_PUUp", 8, asymbins);
TH1D *WJets_nobin_eejj_2018_PUDown = new TH1D ("WJets_nobin_eejj_2018_PUDown", "WJets_nobin_eejj_2018_PUDown", 8, asymbins);
TH1D *WJets_nobin_eejj_2018_centralJesJer = new TH1D ("WJets_nobin_eejj_2018_centralJesJer", "WJets_nobin_eejj_2018_centralJesJer", 8, asymbins);
TH1D *WJets_nobin_eejj_2018_JesSFUp = new TH1D ("WJets_nobin_eejj_2018_JesSFUp", "WJets_nobin_eejj_2018_JesSFUp", 8, asymbins);
TH1D *WJets_nobin_eejj_2018_JesSFDown = new TH1D ("WJets_nobin_eejj_2018_JesSFDown", "WJets_nobin_eejj_2018_JesSFDown", 8, asymbins);
TH1D *WJets_nobin_eejj_2018_JerSFUp = new TH1D ("WJets_nobin_eejj_2018_JerSFUp", "WJets_nobin_eejj_2018_JerSFUp", 8, asymbins);
TH1D *WJets_nobin_eejj_2018_JerSFDown = new TH1D ("WJets_nobin_eejj_2018_JerSFDown", "WJets_nobin_eejj_2018_JerSFDown", 8, asymbins);
TH1D *WJets_nobin_eejj_2018_energyScaleUp = new TH1D ("WJets_nobin_eejj_2018_energyScaleUp", "WJets_nobin_eejj_2018_energyScaleUp", 8, asymbins);
TH1D *WJets_nobin_eejj_2018_energyScaleDown = new TH1D ("WJets_nobin_eejj_2018_energyScaleDown", "WJets_nobin_eejj_2018_energyScaleDown", 8, asymbins);
TH1D *WJets_nobin_eejj_2018_energySigmaUp = new TH1D ("WJets_nobin_eejj_2018_energySigmaUp", "WJets_nobin_eejj_2018_energySigmaUp", 8, asymbins);
TH1D *WJets_nobin_eejj_2018_energySigmaDown = new TH1D ("WJets_nobin_eejj_2018_energySigmaDown", "WJets_nobin_eejj_2018_energySigmaDown", 8, asymbins);
...
for (Int_t i=0;i<a_->GetEntries();i++) {
 ...
 if (Muon_pt->size() > 1 && numOfHighptMu==2 && numOfVetoEle == 0 && numOfBoostedJets>=1){
  ...
  if (HLT_Mu == 1 && Muon_pt->at(0) > 150 && Muon_pt->at(1) > 100 && fabs(Muon_eta->at(0))<2.4 && fabs(Muon_eta->at(1))<2.4 && BoostedJet_pt->at(0) > 190 && (Muon1+Muon2).M()  > 300 ){
   ...
   WJets_nobin_mumujj->Fill((Muon1+Muon2+BoostJet).M(), wg); 
   WJets_nobin_mumujj_2018_AlphaRatio->Fill((Muon1+Muon2+BoostJet).M(), wg*0.85);
   WJets_nobin_mumujj_2018_AlphaRatioUp->Fill((Muon1+Muon2+BoostJet).M(), wg*0.87);
   WJets_nobin_mumujj_2018_AlphaRatioDown->Fill((Muon1+Muon2+BoostJet).M(), wg*0.83);
   WJets_nobin_mumujj_2018_SFUp->Fill((Muon1+Muon2+BoostJet).M(), wg_SFu);
   WJets_nobin_mumujj_2018_SFDown->Fill((Muon1+Muon2+BoostJet).M(), wg_SFd);
   WJets_nobin_mumujj_2018_PUUp->Fill((Muon1+Muon2+BoostJet).M(), wg_PUu);
   WJets_nobin_mumujj_2018_PUDown->Fill((Muon1+Muon2+BoostJet).M(), wg_PUd);
   WJets_nobin_mumujj_2018_PtCorr->Fill((Muon1_ptCorr+Muon2_ptCorr+BoostJet).M(), wg);
   WJets_nobin_mumujj_2018_PtCorrUp->Fill((Muon1_ptCorr+Muon2_ptCorr+BoostJet).M(), wg);
   WJets_nobin_mumujj_2018_PtCorrDown->Fill((Muon1_ptCorr+Muon2_ptCorr+BoostJet).M(), wg);
   if(centralJesJer->at(0)==1)WJets_nobin_mumujj_2018_centralJesJer->Fill((Muon1+Muon2+BoostJet).M(), wg);
   if(JesSFup->at(1)==1)WJets_nobin_mumujj_2018_JesSFUp->Fill((Muon1+Muon2+BoostJet_JESup).M(), wg);
   if(JesSFdown->at(2)==1)WJets_nobin_mumujj_2018_JesSFDown->Fill((Muon1+Muon2+BoostJet_JESdown).M(), wg);
   if(JerSFup->at(3)==1)WJets_nobin_mumujj_2018_JerSFUp->Fill((Muon1+Muon2+BoostJet_JERup).M(), wg);
   if(JerSFdown->at(4)==1)WJets_nobin_mumujj_2018_JerSFDown->Fill((Muon1+Muon2+BoostJet_JERdown).M(), wg);  
  }
 }
 ...
 if (patElectron_pt->size() > 1 && numOfHighptEle==2 && numOfLooseMu==0 && numOfBoostedJets>=1){
  ...
  if (HLT_Ele == 1 && patElectron_pt->at(0) > 150 && patElectron_pt->at(1) > 100 && fabs(patElectron_eta->at(1))<2.4 && fabs(patElectron_eta->at(0))<2.4 && BoostedJet_pt->at(0) > 190 && (Electron1+Electron2).M() > 300){
   ...
   WJets_nobin_eejj->Fill((Electron1+Electron2+BoostJet).M(), wg);
   WJets_nobin_eejj_2018_AlphaRatio->Fill((Electron1+Electron2+BoostJet).M(), wg*0.79);
   WJets_nobin_eejj_2018_AlphaRatioUp->Fill((Electron1+Electron2+BoostJet).M(), wg*0.85);
   WJets_nobin_eejj_2018_AlphaRatioDown->Fill((Electron1+Electron2+BoostJet).M(), wg*0.73); 
   WJets_nobin_eejj_2018_SFUp->Fill((Electron1+Electron2+BoostJet).M(), wg_SFu);
   WJets_nobin_eejj_2018_SFDown->Fill((Electron1+Electron2+BoostJet).M(), wg_SFd);
   WJets_nobin_eejj_2018_PUUp->Fill((Electron1+Electron2+BoostJet).M(), wg_PUu);
   WJets_nobin_eejj_2018_PUDown->Fill((Electron1+Electron2+BoostJet).M(), wg_PUd);
   WJets_nobin_eejj_2018_energyScaleUp->Fill((Ele1_ScaleUp+Ele2_ScaleUp+BoostJet).M(), wg);
   WJets_nobin_eejj_2018_energyScaleDown->Fill((Ele1_ScaleDown+Ele2_ScaleDown+BoostJet).M(), wg);
   WJets_nobin_eejj_2018_energySigmaUp->Fill((Ele1_SigmaUp+Ele2_SigmaUp+BoostJet).M(), wg);
   WJets_nobin_eejj_2018_energySigmaDown->Fill((Ele1_SigmaDown+Ele2_SigmaDown+BoostJet).M(), wg);
   if(centralJesJer->at(0)==1)WJets_nobin_eejj_2018_centralJesJer->Fill((Electron1+Electron2+BoostJet).M(), wg);
   if(JesSFup->at(1)==1)WJets_nobin_eejj_2018_JesSFUp->Fill((Electron1+Electron2+BoostJet_JESup).M(), wg);
   if(JesSFdown->at(2)==1)WJets_nobin_eejj_2018_JesSFDown->Fill((Electron1+Electron2+BoostJet_JESdown).M(), wg);
   if(JerSFup->at(3)==1)WJets_nobin_eejj_2018_JerSFUp->Fill((Electron1+Electron2+BoostJet_JERup).M(), wg);
   if(JerSFdown->at(4)==1)WJets_nobin_eejj_2018_JerSFDown->Fill((Electron1+Electron2+BoostJet_JERdown).M(), wg); 
  }
 } 
...
WJets_nobin_eejj_2018_AlphaRatioDown->Write();
WJets_nobin_eejj_2018_SFUp->Write();
WJets_nobin_eejj_2018_SFDown->Write();
WJets_nobin_eejj_2018_PUUp->Write();
WJets_nobin_eejj_2018_PUDown->Write();
WJets_nobin_eejj_2018_centralJesJer->Write();
WJets_nobin_eejj_2018_JesSFUp->Write();
WJets_nobin_eejj_2018_JesSFDown->Write();
WJets_nobin_eejj_2018_JerSFUp->Write();
WJets_nobin_eejj_2018_JerSFDown->Write();
WJets_nobin_eejj_2018_energyScaleUp->Write();
WJets_nobin_eejj_2018_energyScaleDown->Write();
WJets_nobin_eejj_2018_energySigmaUp->Write();
WJets_nobin_eejj_2018_energySigmaDown->Write();
WJets_nobin_mumujj->Write();
WJets_nobin_mumujj_2018_AlphaRatio->Write();
WJets_nobin_mumujj_2018_AlphaRatioUp->Write();
WJets_nobin_mumujj_2018_AlphaRatioDown->Write();
WJets_nobin_mumujj_2018_SFUp->Write();
WJets_nobin_mumujj_2018_SFDown->Write();
WJets_nobin_mumujj_2018_PUUp->Write();
WJets_nobin_mumujj_2018_PUDown->Write();
WJets_nobin_mumujj_2018_centralJesJer->Write();
WJets_nobin_mumujj_2018_JesSFUp->Write();
WJets_nobin_mumujj_2018_JesSFDown->Write();
WJets_nobin_mumujj_2018_JerSFUp->Write();
WJets_nobin_mumujj_2018_JerSFDown->Write();
WJets_nobin_mumujj_2018_PtCorr->Write();
WJets_nobin_mumujj_2018_PtCorrDown->Write();
WJets_nobin_mumujj_2018_PtCorrUp->Write();
f->Write();
f->Close();
