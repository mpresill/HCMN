   ...
   for(uint jet_en = 0; jet_en<rBoostedJet_pt->size(); jet_en++){
    ...
    if(BoostedJet_isIDT==true){
     ...
     if(count == 0 && fabs(JetCorr.Eta())<2.4){
      ...
      cout<<"jetcorr size "<<JetCorr.Pt()->size()<<endl;
      cout<<"bj sf jes up" <<BoostedJet_JesSFup_pt->size()<<endl;
      BoostedJet_JesSFup_pt->push_back( JetCorr.Pt() );//rBoostedJet_Uncorr_pt->at(jet_en) * rBoostedJet_JesSFup->at(jet_en) );
      //////////////////////////////////////////////////      
      //////////////////////////////////////////////////
     }
    }
