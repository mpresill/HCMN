...
for(int i=1; i<10; i++){
   ...
   for(uint r=0; r<rootplas.size(); r++){
      ...
      if(rootplas[r]=="SR_syst_DY_HTincl_LO_Kfactor_new"){      histo_name = VarName_dy;}
      ...
      if(rootplas[r]=="SR_syst_DY_HTincl_LO_Kfactor_new"){EvDY=Events; ErrDY2=ErrEvents*ErrEvents;}
   }
