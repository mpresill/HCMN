...
void Other_Ele_Estimation(){
 ...
 //TCanvas* c1 = new TCanvas("SRshape","SRshape",400,400,1100,800);
  //Declare histos
  TH1F *DY; TH1F *DYstim; TH1F *TT; TH1F *tW; TH1F *TTtW; TH1F *Other; TH1F *data_read; TH1F *data_obs; TH1F *data_sub; TH1F *sig; TH1F *Other2;
  if(!asymbin){
   Other    = new TH1F("","",bin,inRange,endRange);
   Other2   = new TH1F("Other","Other",bin,inRange,endRange); 
  }else{
   Other    = new TH1F("","",bin,asymbins);
   Other2   = new TH1F("Other","Other",bin,asymbins);
  }
